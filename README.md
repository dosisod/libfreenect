...
This fork is a modified version of the library `libfreenect`

Original `README.md` has been moved to ![README.md.old](/README.md.old)

# License

This implementation of the library is released under its original the APACHE v2 license:
